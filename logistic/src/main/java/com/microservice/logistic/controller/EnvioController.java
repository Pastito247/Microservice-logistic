...
import com.microservice.logistic.dto.EnvioRequest;
...
public class EnvioController {
        ...
        public CollectionModel<EntityModel<Envio>> obtenerTodos() {
                List<EntityModel<Envio>> envios = envioService.obtenerTodos().stream()
                                .map(envio -> EntityModel.of(envio,
                                                linkTo(methodOn(EnvioController.class).buscarPorId(envio.getId()))
                                                                .withSelfRel(),
                                                linkTo(methodOn(EnvioController.class).obtenerTodos())
                                                                .withRel("envios")))
        ...
        @PostMapping
        public ResponseEntity<EntityModel<Envio>> guardar(@RequestBody EnvioRequest request) {
